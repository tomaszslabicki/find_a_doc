...
Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
  ...
  var patient = FirebaseFirestore.instance
      .collection('patient')
      .where(FieldPath(['id']), isEqualTo: record.idPatient)
      .get()
      .then((querySnapshot) {
        var patient = querySnapshot.docs.single.data();
        return patient;
      });
  ...
  return Padding(
    ...
    child: Container(
      ...
      child: Card(
        ...
        child: ListTile(
          title: Text(record.dateH.toString() + ' : ' + patient.toString() + ' ' + record.commentaire, style: TextStyle(color: Colors.white)),
